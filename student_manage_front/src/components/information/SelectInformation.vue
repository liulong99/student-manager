      ...
      <el-menu :default-openeds="['1', '3']">
        ...
        <el-menu-item-group>
          ...
          <el-submenu index="1">
            ...
            <el-submenu index="1-2" @click="findgradeid(2)">
              <template slot="title">大二</template>
              <el-menu-item  @click="findgradeclassid(2,1)">1班</el-menu-item>
              <el-menu-item  @click="findgradeclassid(2,2)">2班</el-menu-item>
              <el-menu-item  @click="findgradeclassid(2,3)">3班</el-menu-item>
            </el-submenu>
            <el-submenu index="1-3" @click="findgradeid(3)">
              <template slot="title">大三</template>
              <el-menu-item  @click="findgradeclassid(3,1)">1班</el-menu-item>
              <el-menu-item  @click="findgradeclassid(3,2)">2班</el-menu-item>
              <el-menu-item  @click="findgradeclassid(3,3)">3班</el-menu-item>
            </el-submenu>
          </el-submenu>
